...
const WELCOME_MESSAGE = {
  ...
  parts: [{ type: 'text' as const, text: '👋 ¡Hola! Soy tu mentor de hábitos. ¿Qué hábito te gustaría construir o mejorar hoy? Te ayudaré a diseñar tu rutina, mantener la racha y superar bloqueos.' }]
};

const QUICK_PROMPTS = [
  { text: '💡 ¿Cómo diseño un hábito atómico efectivo hoy?', label: 'Hábitos Atómicos' },
  { text: '🔥 Tengo pereza, ¿cómo evito romper mi racha?', label: 'Disciplina' },
  { text: '🌿 ¿Cómo construyo un hábito de meditación diario?', label: 'Mindfulness' },
  { text: '🚀 Diseña mi rutina de mañana ideal para el enfoque', label: 'Rutina' }
];
        ...
        {showQuickPrompts && (
          ...
          >
            <span className="text-[10px] font-bold text-text-secondary uppercase tracking-wider pl-1 flex items-center gap-1.5">
              <IconSparkles size={12} className="text-accent-gold" /> Sugerencias de hábitos:
            </span>
      ...
      {isLimitReached ? (
        ...
        >
          ...
          <p className="text-[12px] text-text-secondary mb-4 max-w-[285px] leading-relaxed">
            Has usado tus {FREE_DAILY_LIMIT} mensajes del día. Vuelve mañana o actualiza a Pro para conversar de manera ilimitada con tu mentor de hábitos.
          </p>
          <Link 
            href="/paywall"
