...
export default function EnergyParticles() {
  ...
  useEffect(() => {
    ...
    // Colores de consistencia y energía (Spotify Green, Emerald, Teal, Gold)
    const colors = [
      "rgba(29, 185, 84, 0.85)",   // Verde Spotify
      "rgba(34, 197, 94, 0.85)",   // Verde Esmeralda
      "rgba(20, 184, 166, 0.85)",   // Teal/Turquesa
      "rgba(251, 191, 36, 0.9)",   // Dorado / Racha
    ];
    ...
    class Particle {
      ...
      constructor() {
        ...
        this.color = this.type === "currency" || this.type === "sparkle"
          ? "rgba(29, 185, 84, 0.9)" // Verde Spotify
